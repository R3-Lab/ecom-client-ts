...
export const updateProduct = async (
  productId: string,
  product: RequestsProductUpdateProduct,
) => {
  const { data, error } = await fetcher<Product>(`/products/${productId}`, {
    method: "PUT",
    body: JSON.stringify(product),
...
export const getProductCategories = async ({
  ...
  const { data, error } = await fetcher<Category[]>(
    `/products/categories?${urlParams.toString()}`,
  );
...
export const getProductCategory = async (categoryId: string) => {
  ...
  if (error && !data) {
    console.error(
      `Failed to get product category with id ${categoryId}`,
      error,
    );
    throw new Error(error.message);
  }
...
export const addProductCategory = async (
  category: RequestsProductAddCategory,
) => {
...
export const updateProductCategory = async (
  categoryId: string,
  category: RequestsProductUpdateCategory,
) => {
  const { data, error } = await fetcher<Category>(
    `/products/categories/${categoryId}`,
    {
  ...
  if (error && !data) {
    console.error(
      `Failed to update product category with id ${categoryId}`,
      error,
    );
    throw new Error(error.message);
  }
...
export const deleteProductCategory = async (categoryId: string) => {
  ...
  if (error && !data) {
    console.error(
      `Failed to delete product category with id ${categoryId}`,
      error,
    );
    throw new Error(error.message);
  }
...
export const getColors = async () => {
  ...
  const { data, error } = await fetcher<Color[]>(
    `/products/colors?${urlParams.toString()}`,
  );
...
export const updateColor = async (
  colorId: string,
  color: RequestsProductUpdateColor,
) => {
...
export const getMaterials = async () => {
  ...
  const { data, error } = await fetcher<Material[]>(
    `/products/materials?${urlParams.toString()}`,
  );
...
export const updateMaterial = async (
  materialId: string,
  material: RequestsProductUpdateMaterial,
) => {
  const { data, error } = await fetcher<Material>(
    `/products/materials/${materialId}`,
    {
      method: "PUT",
      body: JSON.stringify(material),
    },
  ...
  if (error && !data) {
    console.error(
      `Failed to update product material with id ${materialId}`,
      error,
    );
    throw new Error(error.message);
  }
...
export const deleteMaterial = async (materialId: string) => {
  ...
  if (error && !data) {
    console.error(
      `Failed to delete product material with id ${materialId}`,
      error,
    );
    throw new Error(error.message);
  }
...
export const getSizes = async () => {
  ...
  const { data, error } = await fetcher<Size[]>(
    `/products/sizes?${urlParams.toString()}`,
  );
...
export const updateSize = async (
  sizeId: string,
  size: RequestsProductUpdateSize,
) => {
...
export const getProductTypes = async () => {
  ...
  const { data, error } = await fetcher<ProductType[]>(
    `/products/types?${urlParams.toString()}`,
  );
...
export const updateProductType = async (
  typeId: string,
  type: RequestsProductUpdateProductType,
) => {
  const { data, error } = await fetcher<ProductType>(
