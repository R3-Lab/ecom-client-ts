...
export const getBlogPosts = async () => {
  ...
  const { data, error } = await fetcher<BlogPost[]>(
    `/blog_posts?${urlParams.toString()}`,
  );
...
export const createBlogPost = async (
  args: Omit<
    ...
    "author_id" | "created_by_id" | "ecommerce_site_id"
  >,
) => {
...
export const getBlogCategories = async () => {
  ...
  const { data, error } = await fetcher<BlogPostCategory[]>(
    `/blog_posts/category/all?${urlParams.toString()}`,
  );
...
export const updateBlogCategory = async (
  id: string,
  args: Components.Schemas.EcommerceBackendSchemaRequestsBlogPostsUpdateBlogCategory,
) => {
...
export const updateBlogPost = async (
  id: string,
  args: Components.Schemas.EcommerceBackendSchemaRequestsBlogPostsUpdateBlogPost,
) => {
